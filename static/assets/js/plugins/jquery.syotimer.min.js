...
! function(i, e) {
    ...
    var m = "day",
        ...
        c = {
            ...
            _render: function() {
                for (var e = l(this), t = e.data("syotimer-options"), i = y.getTimerItem(), n = l("<div/>", {
                        class: "syotimer__head"
                    }).html(t.headTitle), o = l("<div/>", {
            ...
            _perSecondHandler: function() {
                ...
                var i = new Date,
                    ...
                    o = y.getDifferenceWithTimezone(i, n, t),
                    r = y.getSecondsToDeadLine(o, t);
            ...
            _applyEffectSwitch: function(e, t) {
                ...
                }, 1e3) : "opacity" !== e || (i = a.data("syotimer-items")[t]) && (n = u.next(t), o = i.data("syotimer-unit-value"), l(".syotimer-cell__value", i).animate({
                    opacity: .1
                }, 1e3, "linear", function() {
                    c._perSecondHandler.apply(r, [])
