...
! function(e, t, n) {
    ...
    function g(e, t, o, i) {
        ...
        for (var f, d, p, m, h, g = ["modernizr", "tspan", "samp"]; !R.style && g.length;) f = !0, R.modElem = l(g.shift()), R.style = R.modElem.style;
    ...
    S.hasEvent = O, Modernizr.addTest("pointerevents", function() {
        var e = !1,
            t = P.length;
        for (e = Modernizr.hasEvent("pointerdown"); t-- && !e;) O(P[t] + "pointerdown") && (e = !0);
        return e
    });
    var L = function(e, t) {
        var n = !1,
    ...
    S.testAllProps = A, Modernizr.addTest("flexbox", A("flexBasis", "1px", !0)), Modernizr.addTest("cssanimations", A("animationName", "a", !0)),
        function() {
            ...
            for (var e, t, n = ["Width", "Span", "Fill", "Gap", "Rule", "RuleColor", "RuleStyle", "RuleWidth", "BreakBefore", "BreakAfter", "BreakInside"], r = 0; r < n.length; r++) e = n[r].toLowerCase(), t = A("column" + n[r]), ("breakbefore" === e || "breakafter" === e || "breakinside" == e) && (t = t || A(n[r])), Modernizr.addTest("csscolumns." + e, t)
